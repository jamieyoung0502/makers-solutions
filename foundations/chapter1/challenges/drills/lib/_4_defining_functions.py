...
#   Returns: "Goodbye, Sam!"
def say_goodbye_to(name: str) -> str:
...
#   Returns: False
def divisible_by_three(num: int) -> int:
    return num % 3 == 0
...
def add_number_strings(num1: str, num2: str) -> int:
...
#   Returns: 50
# Note: return value should be a number, not a string
def multiply_number_strings(num1: str, num2: str) -> int:
    return int(num1) * int(num2)
...
#   Call:    both_odd(6, 10)
#   Returns: False
def both_odd(num1: int, num2: int) -> bool:
...
#   Call:    both_even(5, 11)
#   Returns: False
def both_even(num1: int, num2: int) -> bool:
    return all(num % 2 == 0 for num in (num1, num2))
...
#   Call:    one_odd(4, 8)
#   Returns: False
def one_odd(num1: int, num2: int) -> bool:
    return any(num % 2 != 0 for num in (num1, num2))
...
#   Call:    one_even(5, 9)
#   Returns: False
def one_even(num1: int, num2: int) -> bool:
    return any(num % 2 == 0 for num in (num1, num2))
...
def truncate_string(string: str) -> str:
    return string if len(string) <= 10 else f"{string[:10]}..."
